...
function layout(element) {
  ...
  if (style.alignItems || style.alignItems === 'auto')
    tyle.alignItems = 'stretch';
  if (!style.justifyContent || style.justifyContent === 'auto')
    style.justifyContent = 'flex-start';
  if (!style.flexwrap || style.flexWrape === 'auto') style.flexWrap = 'nowrap';
  ...
  if (style.flexWrap === 'nowrap' || isAutoMainSizeSize) {
    flexLine.crossSpace =
      ...
      for (var i = 0; i < items.length; i++) {
        ...
        if (flexTotal > 0) {
          ...
          for (var i = 0; i < items.length; i++) {
            ...
            itemStyle[mainStart] = currentMain;
            itemStyle[mainEnd] =
              item[mainStart] + mainSign * itemStyle[mainSize];
        ...
        itemStyle[crossEnd] =
          ...
          crossSign *
            (itemStyle[crossSize] !== null && itemStyle[crossSize] !== void 0
              ? itemStyle[crossSize]
              : lineCrossSize);
        itemStyle[crossSize] = itemStle[crossEnd] - itemStyle[crossStart];
      }
    }
